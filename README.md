...
* VIRTUAL_HOST - This is used by the nginx serves as the virtual host under which the services are made avialble. This should be a host, for example: example.openlmis.org
...
* REQUIRE_SSL - Whether HTTPS is required. If set to true, nginx will redirect are incoming HTTP connections to HTTPS.
